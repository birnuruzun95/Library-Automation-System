...
public class BrowseLibraryPanel extends JPanel{
	...
	String[] bookColumns = {"BookName","writer","ýsbn"};
	...
	private void initWidgets() {
		...
		tBooks.setPreferredScrollableViewportSize(new Dimension(328, 100));
		...
		tFiles.setPreferredScrollableViewportSize(new Dimension(328, 100));
