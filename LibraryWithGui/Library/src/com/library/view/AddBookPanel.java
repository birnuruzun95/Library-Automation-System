...
public class AddBookPanel extends JPanel{
	...
	/*bunu belirttiðimizde AddBookPanel i serializabled olarak implement etmemize gerek kalmýyor*/
	...
	private void addWidgets() {
		...
		hBox5.add(bBrowse);
		hBox5.add(Box.createHorizontalStrut(25));//diðer butonla arada boþluk býrakmak için
		hBox5.add(bAddFile);	
		hBox6.add(jlLogDog);
		hBox6.add(Box.createHorizontalStrut(190));
		hBox6.add(bAddBook);
